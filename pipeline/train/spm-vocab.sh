...
"${MARIAN}/spm_train" --bos_id=-1 --eos_id=0 --unk_id=1 --user_defined_symbols=augmentsymbol0,augmentsymbol1,augmentsymbol2,augmentsymbol3,augmentsymbol4,augmentsymbol5,augmentsymbol6,augmentsymbol7,augmentsymbol8,augmentsymbol9 \
